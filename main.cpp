...
static const string mainnet_seeds[] = {"seed1.litecoinpos.org", "seed2.litecoinpos.org", "seed3.litecoinpos.org", "seed4.litecoinpos.org", ""};
static const string testnet_seeds[] = {"testnet-seed1.litecoinpos.org", "testnet-seed2.litecoinpos.org", "testnet-seed3.litecoinpos.org", "testnet-seed4.litecoinpos.org", ""};
static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("kjy2eqzk4zwi5zd3.onion", 58930), true);
  }
  do {
